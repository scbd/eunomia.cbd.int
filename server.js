...
app.all('/socket.io/*', function(req, res) { proxy.web(req, res, { target: 'http://api.cbddev.xyz', secure: false } ); } );
// app.all('/api/*', function(req, res) { proxy.web(req, res, { target: 'http://api.cbddev.xyz', secure: false } ); } );
