...
return  ['$scope','mongoStorage', '$timeout', '$rootScope', 'ngDialog', '$document','$route',
    function($scope, mongoStorage, $timeout, $rootScope, ngDialog, $document,$route) {
      var $element;
      $scope.sideEvents = [];
      $scope.days = [];
      $scope.meeting = 0;
      ...
      function loadTypes(s) {
        ...
        if(s)
          $scope.schema=s;
        var q ={schema:$scope.schema, 'meta.status':{'$nin':['deleted','archived']}};
